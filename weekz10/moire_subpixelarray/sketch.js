...
function draw() {
  ...
  radius = 20;//map(sin(frameCount*0.0005),-1,1,4,5);//5;
//radius = avg(lastD);
//alph();
  ...
  redShader.setUniform('isMobile', isMobile);
    redShader.setUniform('u_mouse', [mx, my]);
  ...
  greenShader.setUniform('u_mouse', [mx, my]);
...
//  greenShader.setUniform('tex1', alphapg);
  ...
  blueShader.setUniform('u_mouse', [mx, my]);
