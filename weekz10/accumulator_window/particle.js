class Particle {
  ...
  colour(rand) {
    ...
    if (this.rand > 0 && this.rand < 50) {
      this.c = color(0, 0, 255); //this.img.get(this.home.x / skip, this.home.y / skip);
  } else if (this.rand > 50 && this.rand < 75) {
      this.c = color(0, 255, 0); //this.img.get(this.home.x / skip, this.home.y / skip)
  }else{
...
update() {
  ...
  if (this.lifespan > (100 - (particlecount / 2.0)) && this.local_force == true) {
    this.lifespan -= 0.5;
  }
  if (this.fill_alpha > (100 - (particlecount / 2.0)) && this.local_force == true) {
    this.fill_alpha -= 1.0;
  }

  if (this.lifespan >= 0.0 && this.lifespan <= (100 - (particlecount / 2.0)) && this.local_force == true) {
    this.lifespan += .5;
  }
  if (this.fill_alpha >= 0.0 && this.fill_alpha <= (100 - (particlecount / 2.0)) && this.local_force == true) {
    this.fill_alpha += .5;
  }
