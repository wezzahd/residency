 ...
 this.applyForce(ali);
  ...
  sizing() {
    ...
    this.alpha = floor((this.rgb.x + this.rgb.y +this.rgb.z)/6);
     ...
     rect(this.position.x+(w/3), this.position.y, (this.size/3)*this.sizerr/10, this.size * this.sizerr);
      ...
      rectMode(CENTER);
     //rect(this.position.x,this.position.y,this.size,this.size);
      rect(this.position.x+(w/3*2), this.position.y, (this.size/3)*this.sizerr/10, this.size * this.sizerr);
      ...
      rectMode(CENTER);
    //  rect(this.position.x,this.position.y,this.size,this.size);
    rect(this.position.x+(w/3*3), this.position.y, (this.size/3)*this.sizerr/10, this.size * this.sizerr);
