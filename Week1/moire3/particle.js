...
redpg.rectMode(CENTER);
redpg.rect(this.pos.x,this.pos.y,this.size/sizing, this.size);
...
if (this.channel ==  1){
  //GREEN
  greenpg.noStroke();
  greenpg.fill(0, this.rgb.x,0,this.fillalpha);
//greenpg.rectMode(CENTER);
  ...
  greenpg.rectMode(CENTER);
  greenpg.rect(this.pos.x,this.pos.y,this.size/sizing, this.size);
...
if (this.channel ==  2){
  //BLUE
  bluepg.noStroke();
  bluepg.fill(0, 0, this.rgb.x,this.fillalpha);
...
bluepg.rectMode(CENTER);
bluepg.rect(this.pos.x,this.pos.y,this.size/sizing, this.size);
}
}
