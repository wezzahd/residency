class Particle {
  ...
  update() {
    ...
    this.stroke_alpha_osc = 0.;//this.amplitude * sin(TWO_PI * frameCount / this.period);
    this.fill_alpha_osc = 0.;//(this.amplitude / 3.75) * cos(TWO_PI * frameCount / this.fillperiod);
