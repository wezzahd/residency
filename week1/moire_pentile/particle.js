...
redpg.rectMode(CENTER);
redpg.rect(this.pos.x,this.pos.y,(this.size/3*2),this.size);
}
}
...
//   //greenpg.rect(this.pos.x+(this.size/2), this.pos.y, (this.size/2)*this.sizerr, this.size * this.sizerr);
   greenpg.rectMode(CENTER);
  greenpg.rect(this.pos.x+(this.size/3),this.pos.y,this.size/3,this.size);
...
bluepg.rectMode(CENTER);
 bluepg.rect(this.pos.x,this.pos.y,(this.size/3*2),this.size);
}
}
}
