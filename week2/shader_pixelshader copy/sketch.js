...
function preload(){
  // load the shader
  redShader = loadShader('effect.vert', 'red2.frag');
  greenShader = loadShader('effect.vert', 'green2.frag');
  blueShader = loadShader('effect.vert', 'blue2.frag');
}
...
function draw() {
  ...
  radius = (map(mouseX,0,width,300,2));
